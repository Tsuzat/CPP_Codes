...
int main(){
    ...
    cout<<"Selection sort: ";selection_sort(arr,n); // selection_sort
    cout<<"Bubble sort: ";bubble_sort(arr,n); // bubble_sort
    cout<<"insertion sort: ";insertion_sort(arr,n); //insertion_sort
